...
Nello psudocodice \Alg\ref{alg:1} è riportata la struttura base dell'algoritmo. Infatti, per ogni area vengono chiamate le funzioni \textit{badWeatherAlertsCreator} e \textit{fogFrostAlertsCreator} che si occupano della generazione delle allerte. Queste due funzioni avranno un costo costante per ogni area analizzata. Analizziamo più in dettaglio il costo computazionale delle funzioni:

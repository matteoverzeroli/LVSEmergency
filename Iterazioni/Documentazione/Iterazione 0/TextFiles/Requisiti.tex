...
Per ogni attore devono essere memorizzate le informazioni anagrafiche di base (nome, cognome, CF, residenza). In particolare, per volontari e capisquadra dovrà essere memorizzato anche lo stato operativo: un volontario (o un caposquadra) può dichiararsi operativo solo quando sta partecipando ad un intervento. Quando un volontario è operativo, tutti i membri della squadra potranno visualizzarne la posizione sulla mappa. 
